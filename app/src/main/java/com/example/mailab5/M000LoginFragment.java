...
public class M000LoginFragment extends Fragment implements View.OnClickListener {
 ...
 private void login(String m,String p){
     if(m.isEmpty()||p.isEmpty()){Toast.makeText(mContext,"Empty value",Toast.LENGTH_SHORT).show();return;}
     ...
     if(saved==null){Toast.makeText(mContext,"Email not exist",Toast.LENGTH_SHORT).show();return;}
     if(!saved.equals(p)){Toast.makeText(mContext,"Wrong pass",Toast.LENGTH_SHORT).show();return;}
